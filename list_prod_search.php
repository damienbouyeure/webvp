...
{
    $req_prod="SELECT *FROM produit_vente INNER JOIN categories on categories.id_cat=produit_vente.id_cat WHERE vendu_prodV is null and (nom_prodV LIKE '%$search%' or description_prodV like '%$search%') ";
}
else{
        $req_prod="SELECT *FROM produit_vente INNER JOIN categories on categories.id_cat=produit_vente.id_cat where valid_prodV=1 and vendu_prodV is null and(nom_prodV LIKE '%$search%' or description_prodV like '%$search%')";
}
