...
if($_SESSION['id_clients']==$id_clients || isset($_SESSION['id_admin'])) {
?>
<div class="form-group">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="mail">Adresse</label>  
  <div class="col-md-4">
  <textarea id="mail" name="mail" placeholder="" class="form-control input-xs" disabled><?php
...
<div class="form-group">
  <label class="col-md-4 control-label" for="mail">Ville</label>  
  <div class="col-md-4">
...
<?php
if(!isset($_SESSION['id_clients'])) {}
elseif($_SESSION['id_clients']==$_GET['id_clients']) {
 ?>

<div class="form-group">
  <label class="col-md-4 control-label" for=""></label>
  <div class="col-md-4">
  <input type="submit" name="modifier" value="modifier" class="btn btn-block btn-primary">
    </div>
</div>
<?php
}
