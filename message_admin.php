...
$req_upd_mess="UPDATE commentaire SET id_admin=$id_admin where id_comm=$id_comm";
echo $req_upd_mess;
mysqli_query($bdd,$req_upd_mess);
$req_id_mess="SELECT * FROM commentaire where id_comm=$id_comm";
echo $req_id_mess;
$res_id_mess=mysqli_query($bdd,$req_id_mess);
$row_id=mysqli_fetch_assoc($res_id_mess);
echo $row_id['id_clients'];
$id_clients=$row_id['id_clients'];

$sujet_comm=$_POST["sujet"];
$texte_comm=$_POST['message'];

$req_mess="INSERT INTO commentaire (sujet_comm, texte_commentaire, id_clients, id_admin) VALUES ('$sujet_comm', '$texte_comm', $id_clients, '$id_admin')";
echo $req_mess;
...
<div class="container">
<div class="row">
<form class="form-horizontal" method="POST" action="message_admin.php">
<fieldset>
